...
import { createTransactionClassificationDebugEmbeddings } from "@/features/transaction-classification/server/transaction-classification-debug-service";
...
export async function POST(request: Request) {
    return handleWorkspaceRoute(async (context) => {
        ...
        return NextResponse.json(
            await createTransactionClassificationDebugEmbeddings({
